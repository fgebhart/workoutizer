...
from wkz.parser.fit_parser import FITParser, LapData
...
def test_faulty_fit_file(tmp_path, fit_parser):
    ...
    # now run fit_parser on faulty file and verify that FitHeaderError is raised
